...
let state = Object.assign({}, defaultState, JSON.parse(localStorage.getItem("makanaiWorldV9") || localStorage.getItem("makanaiWorldV8") || localStorage.getItem("makanaiWorldV7") || localStorage.getItem("makanaiWorldV6") || localStorage.getItem("makanaiWorldV5") || "{}"));
...
function persist() { localStorage.setItem("makanaiWorldV9", JSON.stringify(state)); }
